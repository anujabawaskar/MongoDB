...
public class BlogPostDAO {
    ...
    public Document findByPermalink(String permalink) {
        ...
        postsCollection.createIndex(new BasicDBObject("permalink", 1));
    ...
    public List<Document> findByDateDescending(int limit) {
        ...
        postsCollection.createIndex(new BasicDBObject("date", -1));
    ...
    public List<Document> findByTagDateDescending(final String tag) {
        postsCollection.createIndex(new BasicDBObject("tags", 1).append("date", -1));
